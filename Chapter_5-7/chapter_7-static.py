...
parser=argparse.ArgumentParser(description="Generate Monte Carlo simulation graphs for Chapter 7 of the PhD Thesis, with static graphs (alpha = 0).")
...
if input("Run: single beta=2 - timesteps vs p? y/return: ") == "y":
    for ni in range(6, 11):
        ...
        lin=ax.step(pfloat, np.ceil(1/pfloat) + 2, color=colours[2], linestyle =(0, (5, 10)))
